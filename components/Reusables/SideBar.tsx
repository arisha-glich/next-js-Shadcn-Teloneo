  ...
  <div className="fixed left-0 top-0 flex h-screen w-[102px] flex-col justify-between border-r bg-white shadow-lg">
   ...
   <div className="flex-1">
    <nav className="flex flex-col items-center space-y-6">
     <Link
      href="/"
      className={`group flex w-[83px] flex-col items-center rounded-md hover:bg-gray-200 ${activeLink === 'dashboard' ? 'bg-gray-200' : ''}`}
      onClick={() => handleLinkClick('dashboard')}
     >
      <div className="flex h-[40px] w-[55px] items-center justify-center rounded-lg transition-all duration-200">
       <HomeIcon
        className={`h-6 w-6 ${activeLink === 'dashboard' ? 'text-green-600' : 'text-gray-500'} transition-all duration-200 group-hover:text-green-800`}
       />
      </div>
     ...
     <Link
      href="/patients"
      className={`group flex w-[83px] flex-col items-center rounded-md hover:bg-gray-200 ${activeLink === 'patients' ? 'bg-gray-200' : ''}`}
     ...
     >
      <div className="flex h-[42px] w-[42px] items-center justify-center rounded-lg transition-all duration-200">
       <UsersIcon
        className={`h-6 w-6 ${activeLink === 'patients' ? 'text-green-600' : 'text-gray-500'} transition-all duration-200 group-hover:text-green-800`}
       />
      </div>
      <span className="text-sm text-gray-600 group-hover:text-green-800">
       Patients
     ...
     <Link
      href="/appointments"
      className={`group flex w-[93px] flex-col items-center rounded-md hover:bg-gray-200 ${activeLink === 'appointments' ? 'bg-gray-200' : ''}`}
     ...
     >
      <div className="flex h-[42px] w-[39px] items-center justify-center rounded-lg transition-all duration-200">
       <CalendarIcon
        className={`h-6 w-6 ${activeLink === 'appointments' ? 'text-green-600' : 'text-gray-500'} transition-all duration-200 group-hover:text-green-800`}
       />
      </div>
      <span className="text-sm text-gray-600 group-hover:text-green-800">
       Appointments
     ...
     <Link
      href="/doctors"
      className={`group flex w-[83px] flex-col items-center rounded-md hover:bg-gray-200 ${activeLink === 'doctors' ? 'bg-gray-200' : ''}`}
      onClick={() => handleLinkClick('doctors')}
     >
      <div className="flex h-[40px] w-[55px] items-center justify-center rounded-lg transition-all duration-200">
       <DoctorsIcon
        className={`h-6 w-6 ${activeLink === 'doctors' ? 'text-green-600' : 'text-gray-500'} transition-all duration-200 group-hover:text-green-800`}
       />
      </div>
      <span className="text-sm text-gray-600 group-hover:text-green-800">
       Doctors
     ...
     <Link
      href="/payments"
      className={`group flex w-[83px] flex-col items-center rounded-md hover:bg-gray-200 ${activeLink === 'payments' ? 'bg-gray-200' : ''}`}
     ...
     >
      <div className="flex h-[40px] w-[50px] items-center justify-center rounded-lg transition-all duration-200">
       <PaymentsIcon
        className={`h-6 w-6 ${activeLink === 'payments' ? 'text-green-600' : 'text-gray-500'} transition-all duration-200 group-hover:text-green-800`}
       />
      </div>
      <span className="text-sm text-gray-600 group-hover:text-green-800">
       Payments
     ...
     <Link
      href="/contact"
      className={`group flex w-[83px] flex-col items-center rounded-md hover:bg-gray-200 ${activeLink === 'contact' ? 'bg-gray-200' : ''}`}
      onClick={() => handleLinkClick('contact')}
     >
      <div className="flex h-[40px] w-[55px] items-center justify-center rounded-lg transition-all duration-200">
       <ContactIcon
        className={`h-6 w-6 ${activeLink === 'contact' ? 'text-green-600' : 'text-gray-500'} transition-all duration-200 group-hover:text-green-800`}
       />
      </div>
      <span className="text-sm text-gray-600 group-hover:text-green-800">
       Contact Us
