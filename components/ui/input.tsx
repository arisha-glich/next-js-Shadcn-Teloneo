...
const Input = React.forwardRef<HTMLInputElement, InputProps>((
 ...
 const inputClasses = cn(
   'flex h-9 w-full rounded-md border border-input focus:border-primary bg-transparent px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground  focus-visible:ring-1  disabled:cursor-not-allowed disabled:opacity-50 peer',
   'focus:border-primary', // Add this line for green border on focus
