  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-grow p-12 pr-10">
        <div className="mx-auto flex h-[526px] w-[1128px] flex-col gap-4 pl-5">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <Card className="h-[80px] w-[257px] border">
              <CardContent className="flex items-center gap-2 p-2">
                ...
                <div className="flex h-[43px] w-[80px] flex-col justify-center">
                  ...
                  <CardDescription className="font-open-sans p-1 text-[10px] font-[400] leading-[18.16px] text-secondary-foreground">
                    Upcomings
                  </CardDescription>
                </div>
              </CardContent>
          ...
          <div className="mt-4 flex items-center justify-center">
            <div className="text-center">
              ...
              <p>
                ...
                <span className="text-accent-foreground">reviewed</span> by our
                experts.
              </p>
            </div>
          </div>
