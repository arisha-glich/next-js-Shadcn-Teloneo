...
import SwitchIcon from '@/public/Doctors/toggle-on-solid 1.svg';
import SwitchIcon2 from '@/public/Doctors/toggle2.svg';
  ...
  cell: ({ row }) => {
   ...
   return (
    <div className="flex items-center space-x-6">
     ...
     >
      {original.isActive ? (
       <SwitchIcon2 className="h-5 w-10" />
      ) : (
       <SwitchIcon className="h-5 w-10" />
      )}
     </div>
    </div>
   );
